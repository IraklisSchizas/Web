...
(4, 'ΑΜΕΣΗ ΑΝΑΓΚΗ!', 'Παρακαλούνται όλοι όσοι διαθέτουν σε οποιαδήποτε ποσότητα κάποιο από τα παρακάτω είδη, να συμπληρώσουν την φόρμα προσφοράς.', '2024-05-21 16:22:54', '16,17'),
(10, 'Συγκέντρωση αγαθών', 'Παρακαλούνται όσοι διαθέτουν κάποιο από τα ακόλουθα προϊόντα, να συμπληρώσουν την φόρμα προσφοράς για να ενισχυθεί η αποθήκη.', '2024-05-25 18:01:56', '16,17,18,19,20,24,56,71,84,85,91,101,108,116'),
(11, 'Ψαρικά', 'Υπάρχει ανάγκη για είδη ιχθυοπωλείου, καθώς υπάρχουν συγκεκριμένες ομάδες ατόμων που τα χρειάζονται στην καθημερινή τους διατροφή λόγω προβλήματος υγείας.', '2024-05-25 18:06:07', '18'),
(12, 'Ιατρικά είδη', 'Όσοι διαθέτουν πλεόνασμα ιατρικών ειδών παρακαλούνται να προσφέρουν, για να καλυφθούν οι ανάγκες των συμπολιτών μας.', '2024-06-22 17:13:12', '30,31,33,34,46');
...
(2, 'r1', 'Γεώργιος', 'Τεχνολόγος', 6922334455, '38.24532241511494', '21.737070754864686', '202cb962ac59075b964b07152d234b70', 'rescuer'),
(3, 'c1', 'Civi', 'Lian', 2610123456, '38.220588', '21.731126', '202cb962ac59075b964b07152d234b70', 'civilian'),
(4, 'r2', 'Ελένη', 'Σμιθ', 6901122334, '38.241835', '21.744357', '202cb962ac59075b964b07152d234b70', 'rescuer'),
(5, 'r3', 'Άννα', 'Αστερίου', 6977889900, '38.255442', '21.741126', '202cb962ac59075b964b07152d234b70', 'rescuer'),
(6, 'c2', 'Paul', 'Itis', 6998765432, '38.242468', '21.734958', '202cb962ac59075b964b07152d234b70', 'civilian'),
(7, 'john_doe92', 'Ιωάννης', 'Δόης', 6941234567, '38.249802', '21.737602', '202cb962ac59075b964b07152d234b70', 'civilian'),
(8, 'maria_kalli', 'Μαρία', 'Καλλίου', 6938765432, '38.246985', '21.740262', '202cb962ac59075b964b07152d234b70', 'civilian'),
(9, 'nick_1987', 'Νικόλαος', 'Παπαδόπουλος', 6952345678, '38.232485', '21.747606', '202cb962ac59075b964b07152d234b70', 'civilian');
